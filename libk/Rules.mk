CONFIG_LIBK=$(wildcard $(SRCDIR_LIBK)/config/*.h)
...
$(OBJDIR)/libk.o: $(OBJ_LIBK) $(CONFIG_LIBK) $(OBJDIR_LIBK)/asm_irq.o $(OBJDIR_LIBK)/asm_exception.o $(OBJDIR_LIBK)/asm_interrupt.o
	$(LD) $(LD_ALL) $(LD_LIBK) -o $@ $^
