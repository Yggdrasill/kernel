...
$(OBJDIR_STAGE2)/linker.lds: $(SRCDIR_BOOT_COMMON)/bootdefs.lds.S | $(OBJDIR_STAGE2) $(OBJDIR_GEN)/mmap_generated.h
...
$(BINDIR)/stage2.elf: $(OBJDIR_STAGE2)/linker.lds $(OBJDIR)/libk.o $(OBJDIR)/klibc.o $(OBJ_STAGE2) $(OBJ_STAGE1) $(OBJ_COMMON) | $(BINDIR) $(OBJDIR_STAGE2)/linker.lds
